...
class MembraneGeometry:
    ...
    def pb_params(self, **overrides: Any) -> PBParams:
        ...
        ``MEMBRANE_PERIODIC_PB_DEFAULTS`` (see ``mmbsa.py``) is the only
        combination confirmed to run without crashing sander's PB solver for
        a membrane system.
        """
        kwargs: dict[str, Any] = {
            "memopt": 1,
